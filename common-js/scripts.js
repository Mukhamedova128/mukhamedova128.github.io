	...
	if(isExists('#normal-countdown')){
		...
		$('#normal-countdown').countdown(date, function(event) {
			var $this = $(this).html(event.strftime(''
				...
				+ '<div class="time-sec"><h3 class="main-time">%H</h3> <span>Години</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">%M</h3> <span>Хвилини</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">%S</h3> <span>Секунди</span></div>'));
		});
	}
